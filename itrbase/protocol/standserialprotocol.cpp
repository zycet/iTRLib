...
namespace itr_protocol
{
    ...
    S32 StandSerialProtocol::SSPSendPackage(U8 ProtocolID, U8 *Package, S32 PackageLength)
    {
        ...
        {
            return this->DataSendFun->Do(sendBuffer,GetSSFSLength((StandSerialFrameStruct *)sendBuffer));
        }
        return 0;
    }
