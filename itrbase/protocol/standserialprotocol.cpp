        ...
        for( i=0; i<BufferLength; i++)
        {
            ...
            else if (this->receiveBufferState >= 3)//Property+Data+CRC
            {
                ...
                else if (this->receiveBufferState >= len)
                {
                    ...
                    {
                       // this->_ssfs.Length=GetSSFSLength((StandSerialFrameStruct*)Buffer)-(StandSerialProtocolPlusLength);
                        if (this->AutoDecrypt && this->AutoEncrypt)
                            SSPDecrypt((StandSerialFrameStruct*)Buffer, this->Key1, this->Key2);
                        //this->IsHaveNewFrame = True;
                        ;
                        receiveFrameNum++;
//                        if(this->ProcessFunction[SFSProtocolID(&this->SFMS)] != Null)
//                        {
//                            this->ProcessFunction[SFSProtocolID(&this->SFMS)](this, &this->SFMS);
//                        }
...
//
    ...
    */
    void StandSerialProtocol::SetSSFSPackageLength(StandSerialFrameStruct* SSFS,U8 PackageLength)
    {
