...
#ifndef ASICAMERAAPI_H
#define ASICAMERAAPI_H
#define ASICAMERAAPI_API
...
// set auto parameter
ASICAMERAAPI_API void setAutoPara(int iMaxGain, int iMaxExp, int iDestBrightness);
// get auto parameter
ASICAMERAAPI_API void getAutoPara(int *pMaxGain, int *pMaxExp, int *pDestBrightness);
