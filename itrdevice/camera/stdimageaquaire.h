#ifndef STDIMAGEAQUAIRE_H
#define STDIMAGEAQUAIRE_H
...
{
class StdImageAquaire:public IImageAquaire
{
    public:
        StdImageAquaire();
        virtual ~StdImageAquaire();
        enum RawFormat
        {
            RawMono8,
            RawMono16,
        ...
        * \param ExInfo 图像附加信息
        */
        typedef void (*ReceiveFrameCallBack)(StdImageAquaire& StdImageAquaireObj,U8* Raw,S32 Length,void* ExInfo);
